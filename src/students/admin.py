...
class StudentModelAdmin(admin.ModelAdmin):
	list_display = ['pk','registration_number', 'first_name','last_name','gender','currently_enrolled', 'date_of_birth',  'date_joined', 'pkss_school','pkss_class','fee_concession_percent']
