...
class TeacherAttendanceModelAdmin(admin.ModelAdmin):
	...
	list_display = ['pk', 'attendance_date','teacher', 'school', 'school_shift', 'datestamp', 'status', 'notes', 'att_taker']
	list_display_links = ['pk','attendance_date','teacher', 'school', 'school_shift','datestamp', 'status', 'notes', 'att_taker']
